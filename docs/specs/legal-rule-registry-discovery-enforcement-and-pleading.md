...
**Status: MIXED — 22 of 38 entries VERIFIED, 16 UNVERIFIED.** Re-derived from this file at execution, 2026-08-18 (queue-runner, sixty-second invocation), by counting the 38 per-entry `**Status:**` lines rather than carrying the prior header's figures — and never from the packet, whose own orientation figures say so. **Twenty entries carry Michael's sign-off from the Task 19 walk of 2026-08-17** — his word recorded entry by entry in `task-19-signoff-record-2026-08-17.md` §1 (edit E-5, §3 of that record). **The count fell 21 → 20 because one verification DETACHED, not because anything was un-verified:** entry 19b (*Able Supply Co. v. Moye*) was reworded on Michael's ruling of 2026-08-18 (RL-1, `fable-adjudication-record-2026-08-18.md` §2), and verification attaches to wording (#95) — so the 2026-08-17 sign-off no longer attaches to what the entry now says, and re-verification is his at a later look. The other thirteen carry no sign-off, and for them nothing changes: under CLAUDE.md's registry discipline an unverified proposition may exist here and drive warnings or placeholders; **none may be hard-coded, and none may drive a computed legal outcome, until Michael verifies it.** A model asserting legal currency is never verification. **Only Michael verifies.** **Three of the sixteen carry wording ADOPTED under ROUTE-C and are UNVERIFIED BY DESIGN — TRCP 215.4(b), whose Rule line was conformed VERBATIM to the official text at Michael's direction 2026-08-18 (#108); and entries 19a (*Ford Motor Co. v. Castillo*) and 19b (*Able Supply Co. v. Moye*), adopted 2026-08-18 at the Fable adjudication — adoption is not verification, and verification attaches to the new wording at a later look (execute-then-verify, #95). Two entries this sentence formerly named — TRCP 192.3(h) (discoverability) and 191.2 — left it by being VERIFIED at exactly that later look: Michael's word, 2026-08-18 (#108), recorded per entry in `t26-signoff-and-adjudication-record-2026-08-18.md` §§1.1—1.2.**
...
**Five entries added 2026-08-18 (queue-runner, sixty-second invocation), taking the file from thirty-three to thirty-eight status lines.** TRCP 192.3(h) (the **own-statement right** — a third proposition on that subdivision), 193.4(a), 194.2(b)(9), 194.5 and 199.6 entered on Michael's rulings of 2026-08-18 (`Q-WS2-1`, all five limbs, and `Q-WS2-2`; record: `t26-signoff-and-adjudication-record-2026-08-18.md` §2). Texts are verbatim from `registry-new-entry-drafts-2026-08-17.md` §4, placed **in subject order** at the insertion points that document states. **All five are UNVERIFIED and await his sign-off.** A sixth drafted entry (194.1(a)) was **NOT** inserted: Michael ruled it a **second observation** on the VERIFIED "TRCP 194" entry in `legal-rule-registry-discovery-and-carrier-duties.md`, under the one-proposition-one-home rule.
...
**Dedupe already applied — five propositions are NOT here.** TRCP 190.4, 194, 193.3, 193.5, and 192.3(f) already have entries in `legal-rule-registry-discovery-and-carrier-duties.md` (all VERIFIED), so each took a **second observation** there under the one-proposition-one-home rule (the TRCP 193.7 precedent) instead of a duplicate entry here. Three wording questions are flagged for Michael in that file and were deliberately left unresolved. TRCP 193.7 itself is not in either batch. **AMENDED 2026-08-18 (#108) — the Rule 194 line above no longer holds in full, and the span question it rested on is answered.** Michael ruled that entry's scope to be the **WHOLE of Rule 194** (`Q-WS2-1(a)`), and in the same breath ruled three Rule 194 propositions into **this** file's territory: **194.2(b)(9) and 194.5 are now entries here**, while **194.1(a) stayed there as a second observation**. So Rule 194 is deduped-away only as to 194.1(a). The 194.5 entry here carries an express cross-reference to the VERIFIED `## TRCP 192.5(c)(1)` entry in this file, and the carrier-duties TRCP 194 entry carries a reciprocal note back to the 194.5 entry (the #73 keep-as-two pattern).

**Reporter-cite check flagged on SIX case entries.** *In re Volt Power*, *In re Sting Soccer*, *In re Ochoa*, *In re Redman*, *Collins v. Kappa Sigma*, and *De Anda v. Jason C. Webster, P.C.* are carried at Westlaw/slip cites. The packet named the first five; **De Anda is a sixth carrying the same defect, flagged here by Code and not corrected.** Upgrading a slip cite to a reporter cite is a verification act and is Michael's alone — no cite in this file was altered. (This is exactly the currency flag **FE-16** would automate; until it exists the check is by hand.)

**Structure.** Entries are headed by CITE and ordered by subject, carrying no section headings — the convention of the sibling registry file. Rules precede the case propositions that support them; the UIM/pleading cluster follows the discovery-enforcement cluster.
...
**Verified:** 2026-08-18 post-execution look (#108) against the July 2026 TRCP PDF; sole named divergence (dash typography) resolved as-is. Record: §1.2.
...
**Cross-reference (ruled 2026-08-18, #109, Q-WS3-1):** see the VERIFIED entry ## TRCP 192.5(c)(1) — witness statements excepted from work-product protection in this file — the work-product side is settled there; this entry states the attorney-client limit only.
...
**Rule.** Any person may obtain, upon written request, his or her own statement concerning the lawsuit, which is in the possession, custody or control of any party.
**Characterization note (labeled, not rule text).** The right runs to any person — the rule's own word — not only to a party to the suit, and the rule states no condition of a pending discovery request.
**Enforcement cross-reference (ruled 2026-08-18, #109, Q-WS1-1):** enforcement is TRCP 215.1(e)'s own entry in this file — the person who made the request may move to compel and recover expenses; the "A party" preamble tension is flagged there.
**Status:** VERIFIED — Michael, 2026-08-18 (#110).
**Verified:** 2026-08-18 one-look (#110): Rule line character-exact against the July 2026 TRCP PDF extraction; zero flags. Record: five-look-signoff-record-2026-08-18.md §1.
...
**Wording:** adopted 2026-08-18 per #109 (ROUTE-C — Rule line conformed to the rule's exact sentence; the 215.1(e) limb split to its own entry per Q-WS1-1, replacing the prior Dedupe note); verification attaches to this wording.
**Source:** clean-authority PDF, `Documents\Knowledge Repo\Civil\texas-rules-of-civil-procedure July 2026.pdf` ("July 2026" is the filename's designation; no separate effective-date line — caveat accepted at WP-1/2/3). Retrieval: RUN 2026-08-17, raw pdftotext in the device VM, quotations spot-checked in two extraction modes.
...
**Construction note (labeled):** "this rule" in 193.4(a) is Rule 193 — stated here, not substituted into the quoted text.
**Status:** VERIFIED — Michael, 2026-08-18 (#110).
**Verified:** 2026-08-18 one-look (#110): character-exact; zero flags. Record: five-look-signoff-record-2026-08-18.md §1.
...
**Wording:** Rule line conformed VERBATIM to 193.4(a), adopted 2026-08-18 per #109; verification attaches to this wording.
...
**Verified:** 2026-08-18 look (#109) against the July 2026 TRCP PDF; operative quote exact; lead-in and characterization put as such. Record: post-execution-signoff-record-2026-08-18.md §1.
...
**Status:** VERIFIED — Michael, 2026-08-18 (#109).
**Verified:** 2026-08-18 look (#109); quoted sentence is the rule's entire text, exact; scope note asserts nothing on Q-WS2-3, which stays open. Record: post-execution-signoff-record-2026-08-18.md §1.
...
## TRCP 198.1 — subject matter of requests for admission
...
**Status:** VERIFIED — Michael, 2026-08-18 (#110).
**Verified:** 2026-08-18 one-look (#110): character-exact; zero flags; the no-asymmetry passage stands. Record: five-look-signoff-record-2026-08-18.md §1.
...
**Wording:** Rule line conformed VERBATIM to 199.6, adopted 2026-08-18 per #109; verification attaches to this wording.
...
## TRCP 215.1(c) — evasive or incomplete answer treated as a failure to answer
...
## TRCP 215.1(e) — compelling compliance with a person's own-statement request

**Cite:** Tex. R. Civ. P. 215.1(e); the right enforced is Tex. R. Civ. P. 192.3(h).
**Rule.** If a party fails to comply with any person's written request for the person's own statement as provided in Rule 192.3(h), the person who made the request may move for an order compelling compliance. If the motion is granted, the movant may recover the expenses incurred in obtaining the order, including attorney fees, which are reasonable in relation to the amount of work reasonably expended in obtaining the order.
**FLAGGED, NOT RESOLVED (carried from the WS-1 draft; kept by ruling 2026-08-18, #109):** Rule 215.1's preamble grants the application right to "A party, upon reasonable notice to other parties and all other persons affected thereby," while (e) grants the motion to "the person who made the request," who under 192.3(h) need not be a party. No located authority resolves whether a non-party may move under 215.1; this entry asserts no answer.
**Status:** VERIFIED — Michael, 2026-08-18 (#110).
**Verified:** 2026-08-18 one-look (#110): exact two-sentence match; the preamble-tension flag survives as verified text asserting no answer. Record: five-look-signoff-record-2026-08-18.md §1.
**Relied on for:** the enforcement limb of the own-statement right — the intake/adjuster-call posture, where the recorded person is typically not a party.
**Cross-reference:** the right itself is the `## TRCP 192.3(h) — a person's right to his or her own statement` entry above.
**Wording:** the Rule line is Rule 215.1(e)'s exact two sentences (subdivision caption omitted, the file's convention); adopted 2026-08-18 per #109 (Q-WS1-1); verification attaches to this wording.
**Source:** clean-authority PDF, `Documents\Knowledge Repo\Civil\texas-rules-of-civil-procedure July 2026.pdf` (currency caveat as at WP-1/2/3). Retrieval: RUN 2026-08-18, raw pdftotext in the device VM, spot-checked against raw extraction.
...
**Status:** VERIFIED — Michael, 2026-08-18 (#109).
**Verified:** 2026-08-18 one-look (#109): executed verbatim Rule line compared character-level against the July 2026 TRCP PDF extraction — exact match. Record: post-execution-signoff-record-2026-08-18.md §1.
...
**Wording:** adopted 2026-08-17 per #98 (ROUTE-C); verification attaches to this wording.
**Verified:** 2026-08-18 post-execution look (#108): entry text and Rule 191.2 word-for-word identical against the July 2026 TRCP PDF; no residual divergences. Record: t26-signoff-and-adjudication-record-2026-08-18.md §1.1.
...
**Cite:** De Anda v. Jason C. Webster, P.C., 2018 WL 3580579 (Tex. App.—Houston [14th Dist.] 2018, pet. denied).
**Proposition.** A repeated global objection string is waived.
**Status:** UNVERIFIED. **REPORTER-CITE CHECK FLAGGED — added by Code, 2026-08-12.** The fold-in named five WL/slip cites in this batch; this is a **sixth** carrying the same defect. Flagged, not corrected.
**Relied on for:** the BP category and the waiver theory.

## In re Sting Soccer Group, LP, 2017 WL 5897454 (Tex. App.—Dallas 2017, orig. proceeding)

**Cite:** In re Sting Soccer Group, LP, 2017 WL 5897454 (Tex. App.—Dallas 2017, orig. proceeding).
...
**Cite:** In re Ochoa, 2004 WL 1192444 (Tex. App.—Tyler 2004, orig. proceeding).
...
**Cite:** Allstate Ins. Co. v. Irwin, 627 S.W.3d 263 (Tex. 2021).
**Proposition.** The UDJA is a proper vehicle for a UIM-benefit determination and supports a fees award.
